[![SPASE Monthly Validation](https://github.com/hpde/KASI/actions/workflows/validate-schedule.yml/badge.svg)](https://github.com/hpde/KASI/actions/workflows/validate-schedule.yml)
[![SPASE Push Validation](https://github.com/hpde/KASI/actions/workflows/validate-push.yml/badge.svg)](https://github.com/hpde/KASI/actions/workflows/validate-push.yml)

# KASI

Korean Astronomy and Space Science Institute (KASI).

SPASE resource descriptions with the KASI naming authority.
